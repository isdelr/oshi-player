...
function SettingsPage(): JSX.Element {
  const { folders, isScanning, actions: libraryActions } = useLibraryStore()
  const {
    runOnStartup,
    minimizeToTray,
    windowFrameStyle,
        ...
        <div className="max-w-4xl mx-auto space-y-8 pb-8">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                    ...
                    folders.map((path, index) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() => libraryActions.removeFolder(path)}
                          disabled={isScanning}
                        >
                ...
                <div className="flex gap-4 justify-center items-center">
                  <Button className="w-fit" onClick={libraryActions.addFolder} disabled={isScanning}>
            ...
            <CardContent className="space-y-2">
              <div className="flex items-center justify-between p-3 rounded-lg border">
                ...
                <Switch
                  ...
                  onCheckedChange={settingsActions.setRunOnStartup}
                />
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg border">
                <div>
                ...
                <Switch
                  ...
                  onCheckedChange={settingsActions.setMinimizeToTray}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customize the look and feel of the application window. Requires a restart.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <RadioGroup
                ...
                onValueChange={(value) =>
                  settingsActions.setWindowFrameStyle(value as 'custom' | 'native')
                }
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg border">
                ...
                <Switch id="include-songs" defaultChecked disabled />
              </div>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        favorites, and custom settings will be permanently deleted. The application will
                        restart.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction
                        ...
                        onClick={settingsActions.resetApp}
                      >
